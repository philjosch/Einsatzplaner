    ...
    ui(new Ui::MinimumHoursEditorDialog)
{
    ...
    ui->lineGesamt        ->setText(stringForDurationEditorFromMinutes(manager->getMinimumHours(Category::Gesamt)));
}
...
void MinimumHoursEditorDialog::setDefault()
{
    ...
    ui->lineGesamt        ->setText(stringForDurationEditorFromMinutes(manager->getMinimumHoursDefault(Category::Gesamt)));
    update();
}
