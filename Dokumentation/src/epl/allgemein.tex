...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.3\textwidth}
    \includegraphics[width=\textwidth]{EPL/EPL.png}
    \caption{Logo von \EPL}
  \end{subfigure}

  \begin{subfigure}{0.3\textwidth}
    \includegraphics[width=\textwidth]{Einsatzplaner/Einsatzplaner.png}
    \caption{Logo des \Einsatz}
  \end{subfigure}%
  \qquad%
  \begin{subfigure}{0.3\textwidth}
    \includegraphics[width=\textwidth]{Personalplaner/Personalplaner.png}
...
Die Bilder in dieser Dokumentation stammen sowohl von Entwicklerversionen als auch von früheren Versionen des Programms.
Dadurch können Darstellungen und Funktionen
vom beschriebenen Funktionsumfang abweichen.

Eine Aufstellung der Veränderungen und Neuerungen
zwischen den einzelnen Versionen finden Sie unter
 \url{https://github.com/philjosch/Einsatzplaner/blob/master/CHANGELOG.md}.

Eine aktuelle Version des Programms und weitere Informationen
finden Sie auf der Webseite \url{http://epl.philipp-schepper.de}
