...
\neu{
\section{\neu{Installation}}\label{sonstiges:installation}
\subsection{\neu{macOS}}
Laden Sie das bereitgestellte Programm herunter und entpacken Sie die \texttt{.dmg}-Datei durch einen Doppelklick.
...
\begin{itemize}
  ...
  \item Merken Sie sich den Pfad, an dem Sie den Einsatzplaner installieren, z.B.\ \texttt{C:\/Program Files (x86)\/Einsatzplaner}.
  ...
  \item Dort finden Sie eine Datei "`vc\_redist.x64"'.
