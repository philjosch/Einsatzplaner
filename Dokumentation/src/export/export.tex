...
Es stehen folgende Übersichten zur Verfügung, die alle über das Menü "`Exportieren"' im Fenster des \neu{Mitgliederverwaltung} aufgerufen werden können:
\begin{description}
  \item[\neu{Einsatzzeiten der Mitglieder}]
  ...
  \item[\neu{Einzelansichten der Mitglieder}]
...
\neu{Auch können die persönlichen Daten auch nur für die aktuelle Person ausgegeben werden.}
